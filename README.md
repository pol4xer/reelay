...
Видео не формата 9:16 помещаются целиком на холст 1080×1920 с размытым фоном. Бот создаёт 17 тегов: сначала исходные и точные тематические, затем соседние по теме и несколько широких охватных. Идея определяется по caption, исходному описанию, тексту и объектам в кадрах через Apple Vision.
